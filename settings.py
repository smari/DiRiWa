# Django settings for EULobby project.
...
DATABASES = {
    'default': {
        ...
        'NAME': here('diriwa.sqlite3'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'jlx8lh1^q!xrsp0&4l&)3g_%7p9m_^g43ixw*flirg^rndq0xj'
